...
--
-- Servidor: localhost
-- Tiempo de generación: 17-06-2020 a las 12:05:53
...
ALTER TABLE `Tasks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_recipeTask` (`recipeid`),
  ADD KEY `fk_summaryTask` (`summaryid`);
...
--
ALTER TABLE `Tasks`
  ADD CONSTRAINT `fk_recipeTask` FOREIGN KEY (`recipeid`) REFERENCES `Recipes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_summaryTask` FOREIGN KEY (`summaryid`) REFERENCES `SummarySheets` (`id`);
